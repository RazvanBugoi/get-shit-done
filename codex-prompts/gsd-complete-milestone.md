...
- Read file: ~/.codex/get-shit-done/workflows/complete-milestone.md (main workflow)
- Read file: ~/.codex/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
