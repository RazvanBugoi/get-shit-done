...
Output: Context gathered, then routes to /prompts:gsd-new-milestone
</objective>

<execution_context>
Read file: ~/.codex/get-shit-done/workflows/discuss-milestone.md
</execution_context>
...
Read file: .planning/MILESTONES.md
</context>
...
4. Hand off to /prompts:gsd-new-milestone with gathered context
...
- Context handed off to /prompts:gsd-new-milestone
  </success_criteria>
